...
@autobind
export default class LotteryConfirm extends React.Component<IProps, {}> {
    ...
    render() {
        return createPortal(
            <section className={`co-lottery-dialog-container ${ this.state.show ? '' : 'hide' }`}>
                <aside className='co-bg' onClick={ this.hide }></aside>

                <main className='co-dialog-main'>
                    <header className='co-dialog-title'>
                        <img src={ this.props.titleImage } className='co-dialog-title-image' />
                    </header>
                    <main className='co-dialog-content'>
                        { this.props.children }
                    </main>
